...
`;
  ...
  (function() {
    ...
    if (!transformersLibLoaded && typeof __require !== "undefined") {
      ...
      if (!document.getElementById(scriptId)) {
        ...
        script.textContent = `
          ...
          ","
                  ...
                  window.transformers.env.cacheDir = '.cache/huggingface/transformers';
                  window.transformers.env.backends.onnx.logLevel = 'info';
                  console.log('[ASR] Transformers library loaded and configured with caching enabled.');
      ...
      window.transformers.env.cacheDir = '.cache/huggingface/transformers';
      window.transformers.env.backends.onnx.logLevel = "info";
      console.log('[ASR] Transformers library caching configuration applied.');
    }
